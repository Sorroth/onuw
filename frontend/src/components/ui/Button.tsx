 ...
 *
 * @description
 * A versatile button component supporting multiple variants (primary, secondary,
 * danger, ghost), sizes, and loading states. Uses forwardRef for ref forwarding.
 *
 * @pattern Composite Pattern - Composes HTML button with styling and loading indicator
 */
